...
const scada::NumericId Iec61850ConfigurableObjectType = 384; // ObjectType
const scada::NumericId Iec61850ConfigurableObjectType_Reference = 385; // Variable
const scada::NumericId Iec61850DeviceType = 371; // ObjectType
const scada::NumericId Iec61850DeviceType_Disabled = 372; // Variable
const scada::NumericId Iec61850DeviceType_Enabled = 374; // Variable
const scada::NumericId Iec61850DeviceType_Host = 382; // Variable
const scada::NumericId Iec61850DeviceType_Interrogate = 375; // Method
const scada::NumericId Iec61850DeviceType_InterrogateChannel = 376; // Method
const scada::NumericId Iec61850DeviceType_Model = 381; // Object
const scada::NumericId Iec61850DeviceType_Online = 373; // Variable
const scada::NumericId Iec61850DeviceType_Port = 383; // Variable
const scada::NumericId Iec61850DeviceType_Select = 378; // Method
const scada::NumericId Iec61850DeviceType_SyncClock = 377; // Method
const scada::NumericId Iec61850DeviceType_Write = 379; // Method
const scada::NumericId Iec61850DeviceType_WriteParam = 380; // Method
const scada::NumericId Iec61850LogicalNodeType = 370; // ObjectType
const scada::NumericId Iec61850RcbType = 386; // ObjectType
const scada::NumericId Iec61850RcbType_Reference = 387; // Variable
...
const scada::NodeId Iec61850ConfigurableObjectType{numeric_id::Iec61850ConfigurableObjectType, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850ConfigurableObjectType_Reference{numeric_id::Iec61850ConfigurableObjectType_Reference, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType{numeric_id::Iec61850DeviceType, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType_Disabled{numeric_id::Iec61850DeviceType_Disabled, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType_Enabled{numeric_id::Iec61850DeviceType_Enabled, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType_Host{numeric_id::Iec61850DeviceType_Host, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType_Interrogate{numeric_id::Iec61850DeviceType_Interrogate, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType_InterrogateChannel{numeric_id::Iec61850DeviceType_InterrogateChannel, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType_Model{numeric_id::Iec61850DeviceType_Model, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType_Online{numeric_id::Iec61850DeviceType_Online, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType_Port{numeric_id::Iec61850DeviceType_Port, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType_Select{numeric_id::Iec61850DeviceType_Select, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType_SyncClock{numeric_id::Iec61850DeviceType_SyncClock, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType_Write{numeric_id::Iec61850DeviceType_Write, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850DeviceType_WriteParam{numeric_id::Iec61850DeviceType_WriteParam, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850LogicalNodeType{numeric_id::Iec61850LogicalNodeType, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850RcbType{numeric_id::Iec61850RcbType, NamespaceIndexes::SCADA};
const scada::NodeId Iec61850RcbType_Reference{numeric_id::Iec61850RcbType_Reference, NamespaceIndexes::SCADA};
