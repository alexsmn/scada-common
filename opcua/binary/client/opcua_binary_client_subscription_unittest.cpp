...
class OpcUaBinaryClientSubscriptionTest : public ::testing::Test {
 protected:
...
TEST_F(OpcUaBinaryClientSubscriptionTest, CreateCapturesSubscriptionId) {
...
TEST_F(OpcUaBinaryClientSubscriptionTest,
...
TEST_F(OpcUaBinaryClientSubscriptionTest, DeleteMonitoredItemDropsHandler) {
  auto state = std::make_shared<ScriptedState>();
  state->incoming.push_back(AsString(BuildServiceResponseFrame(
      2, 1,
      OpcUaResponseBody{OpcUaCreateSubscriptionResponse{
...
TEST_F(OpcUaBinaryClientSubscriptionTest, DeleteClearsServerSubscription) {
  auto state = std::make_shared<ScriptedState>();
  state->incoming.push_back(AsString(BuildServiceResponseFrame(
      2, 1,
      OpcUaResponseBody{OpcUaCreateSubscriptionResponse{
