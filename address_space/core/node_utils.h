...
bool IsSubtypeOf(Configuration& address_space, const NodeId& type_id, const NodeId& supertype_id);
...
void AddReference(scada::Configuration& address_space, const scada::NodeId& reference_type_id, const scada::NodeId& source_id, const scada::NodeId& target_id);
void AddReference(scada::Configuration& address_space, const scada::NodeId& reference_type_id, scada::Node& source, scada::Node& target);
void DeleteReference(scada::Configuration& address_space, const scada::NodeId& reference_type_id, const scada::NodeId& source_id, const scada::NodeId& target_id);
void DeleteAllReferences(scada::Node& node);
