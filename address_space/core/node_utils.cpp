...
void AddReference(scada::Configuration& address_space, const scada::NodeId& reference_type_id, const scada::NodeId& source_id,
...
void DeleteReference(scada::Configuration& address_space, const scada::NodeId& reference_type_id, const scada::NodeId& source_id,
                                         const scada::NodeId& target_id) {
  auto* reference_type = AsReferenceType(address_space.GetNode(reference_type_id));
  assert(reference_type);
