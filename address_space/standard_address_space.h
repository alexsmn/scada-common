...
struct StandardAddressSpace {
  ...
  scada::ReferenceType HierarchicalReference{scada::id::HierarchicalReferences, "HierarchicalReference", {}};
  scada::ReferenceType NonHierarchicalReference{scada::id::NonHierarchicalReferences, "NonHierarchicalReference", {}};
  ...
  scada::ReferenceType HasTypeDefinition{scada::id::HasTypeDefinition, "HasTypeDefinition", {}};
  scada::ReferenceType HasModellingRule{scada::id::HasModellingRule, "HasModellingRule", {}};
  ...
  scada::DataType LocalizedTextDataType{scada::id::LocalizedText, "LocalizedText", {}};
