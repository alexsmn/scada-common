...
scada::Variable* AddProperty(AddressSpaceImpl& address_space,
  ...
  if (!category_id.is_null()) {
    AddReference(address_space, id::HasPropertyCategory, prop_type_id,
                 category_id);
  }
...
scada::ReferenceType* CreateReferenceType(
  ...
  if (!category_id.is_null()) {
    AddReference(address_space, id::HasPropertyCategory, reference_type_id,
                 category_id);
  }
...
void CreateScadaAddressSpace(AddressSpaceImpl& address_space,
  ...
  // Property Categories.
  {
    ...
    generic_node_factory.CreateNode(
        {id::PropertyCategories, scada::NodeClass::Object,
    ...
    generic_node_factory.CreateNode(
        {id::PropertyCategories_General, scada::NodeClass::Object,
         scada::id::FolderType, id::PropertyCategories, scada::id::Organizes,
         scada::NodeAttributes().set_browse_name("General").set_display_name(
             base::WideToUTF16(L"Общие"))});

    generic_node_factory.CreateNode(
        {id::PropertyCategories_Channels, scada::NodeClass::Object,
         scada::id::FolderType, id::PropertyCategories, scada::id::Organizes,
         scada::NodeAttributes()
    ...
    generic_node_factory.CreateNode(
        {id::PropertyCategories_Conversion, scada::NodeClass::Object,
         scada::id::FolderType, id::PropertyCategories, scada::id::Organizes,
         scada::NodeAttributes()
    ...
    generic_node_factory.CreateNode(
        {id::PropertyCategories_Filtering, scada::NodeClass::Object,
         scada::id::FolderType, id::PropertyCategories, scada::id::Organizes,
         scada::NodeAttributes()
    ...
    generic_node_factory.CreateNode(
        {id::PropertyCategories_Limits, scada::NodeClass::Object,
         scada::id::FolderType, id::PropertyCategories, scada::id::Organizes,
  ...
  // TsFormat
  {
    ...
    AddProperty(address_space, id::TsFormatType, id::TsFormatType_CloseColor,
                {}, "CloseColor", base::WideToUTF16(L"Цвет 1"),
                scada::id::Int32, 0);
  }
  ...
  // DataItem
  {
    ...
    AddProperty(address_space, id::DataItemType, id::DataItemType_Input1,
                id::PropertyCategories_Channels, "Input1",
  ...
  // DiscreteItem
  {
    ...
    AddProperty(address_space, id::DiscreteItemType,
                id::DiscreteItemType_Inversion,
                id::PropertyCategories_Conversion, "Inverted",
                base::WideToUTF16(L"Инверсия"), scada::id::Boolean, false);
    CreateReferenceType(address_space, id::DiscreteItemType, id::HasTsFormat,
                        id::PropertyCategories_Display, "HasTsFormat",
                        base::WideToUTF16(L"Параметры"), id::TsFormatType);
  }
  ...
  // AnalogItem
  {
    ...
    AddProperty(address_space, id::AnalogItemType, id::AnalogItemType_EuLo,
                id::PropertyCategories_Conversion, "EuLo",
    ...
    AddProperty(address_space, id::AnalogItemType, id::AnalogItemType_IrHi,
                id::PropertyCategories_Conversion, "IrHi",
    ...
    AddProperty(address_space, id::AnalogItemType, id::AnalogItemType_LimitLo,
                id::PropertyCategories_Limits, "LimitLo",
  ...
  // IEC-60870 Link Device
  {
    ...
    AddProperty(address_space, id::Iec60870LinkType,
                ...
                30);
    AddProperty(
        address_space, id::Iec60870LinkType,
        id::Iec60870LinkType_ConfirmationTimeout, {}, "ConfirmationTimeout",
        base::WideToUTF16(L"Таймаут подтверждения, с"), scada::id::Int32, 5);
    AddProperty(address_space, id::Iec60870LinkType,
  ...
  // IEC-60870 Device
  {
    ...
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup1, {},
                "Group1PollPeriod",
                base::WideToUTF16(L"Период опроса группы 1, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup2, {},
                "Group2PollPeriod",
                base::WideToUTF16(L"Период опроса группы 2, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup3, {},
                "Group3PollPeriod",
                base::WideToUTF16(L"Период опроса группы 3, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup4, {},
                "Group4PollPeriod",
                base::WideToUTF16(L"Период опроса группы 4, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup5, {},
                "Group5PollPeriod",
                base::WideToUTF16(L"Период опроса группы 5, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup6, {},
                "Group6PollPeriod",
                base::WideToUTF16(L"Период опроса группы 6, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup7, {},
                "Group7PollPeriod",
                base::WideToUTF16(L"Период опроса группы 7, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup8, {},
                "Group8PollPeriod",
                base::WideToUTF16(L"Период опроса группы 8, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup9, {},
                "Group9PollPeriod",
                base::WideToUTF16(L"Период опроса группы 9, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup10, {},
                "Group10PollPeriod",
                base::WideToUTF16(L"Период опроса группы 10, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup11, {},
                "Group11PollPeriod",
                base::WideToUTF16(L"Период опроса группы 11, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup12, {},
                "Group12PollPeriod",
                base::WideToUTF16(L"Период опроса группы 12, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup13, {},
                "Group13PollPeriod",
                base::WideToUTF16(L"Период опроса группы 13, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup14, {},
                "Group14PollPeriod",
                base::WideToUTF16(L"Период опроса группы 14, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup15, {},
                "Group15PollPeriod",
                base::WideToUTF16(L"Период опроса группы 15, с"),
                scada::id::Int32, 0);
    AddProperty(address_space, id::Iec60870DeviceType,
                id::Iec60870DeviceType_InterrogationPeriodGroup16, {},
                "Group16PollPeriod",
  ...
  // IEC-61850 Device
  {
    ...
    AddProperty(address_space, id::Iec61850DeviceType,
                id::Iec61850DeviceType_Host, {}, "Host",
                base::WideToUTF16(L"Хост"), scada::id::String, scada::String{});
    AddProperty(address_space, id::Iec61850DeviceType,
                id::Iec61850DeviceType_Port, {}, "Port",
  ...
  // IEC Retransmission Item
  {
    ...
    CreateReferenceType(address_space, id::TransmissionItemType,
                        ...
                        scada::id::BaseVariableType);
    CreateReferenceType(
        address_space, id::TransmissionItemType, id::HasTransmissionTarget, {},
  ...
  {
    node_factory.CreateNode(
        {id::FileSystem, scada::NodeClass::Object, scada::id::FolderType,
         scada::id::ObjectsFolder, scada::id::Organizes,
         scada::NodeAttributes{}
