...
scada::ObjectType* CreateObjectType(AddressSpaceImpl& address_space,
  ...
  if (!supertype_id.is_null()) {
    auto* supertype = address_space.GetMutableNode(supertype_id);
    assert(supertype &&
...
scada::Variable* AddProperty(AddressSpaceImpl& address_space,
  ...
  auto* type = address_space.GetMutableNode(type_id);
...
scada::ReferenceType* CreateReferenceType(
  ...
  auto* source_type = address_space.GetMutableNode(source_type_id);
  assert(source_type &&
         (source_type->GetNodeClass() == scada::NodeClass::ObjectType ||
          source_type->GetNodeClass() == scada::NodeClass::VariableType));

  auto* target_type = address_space.GetMutableNode(target_type_id);
  assert(target_type);
...
void AddDataVariable(AddressSpaceImpl& address_space,
  ...
  auto* existing_prop = address_space.GetMutableNode(variable_decl_id);
  ...
  if (!result) {
    auto* variable_type = scada::AsVariableType(
        address_space.GetMutableNode(scada::id::BaseVariableType));
...
void CreateFileSystemAddressSpace(AddressSpaceImpl& address_space,
  ...
  node_factory.CreateNode({filesystem::id::FileSystem, scada::NodeClass::Object,
...
void CreateScadaAddressSpace(AddressSpaceImpl& address_space,
  ...
  // Historical DB
  {
    ...
    AddDataVariable(address_space, history::id::HistoricalDatabaseType,
                    ...
                    scada::id::UInt32);
    AddDataVariable(
        address_space, history::id::HistoricalDatabaseType,
  ...
  CreateEnumDataType(
      address_space, devices::id::ModbusModeDataType,
  ...
  // Modbus Port Device
  {
    ...
    AddProperty(address_space, devices::id::ModbusLinkType,
                ...
                0);
    AddProperty(address_space, devices::id::ModbusLinkType,
                devices::id::ModbusLinkType_Mode, {}, "Mode",
                base::WideToUTF16(L"Режим"), devices::id::ModbusModeDataType,
                0);
    AddProperty(address_space, devices::id::ModbusLinkType,
  ...
  CreateFileSystemAddressSpace(address_space, node_factory);

  // OPC
  {
    node_factory.CreateNode(
        {opc::id::OPC, scada::NodeClass::Object, scada::id::FolderType,
         scada::id::ObjectsFolder, scada::id::Organizes,
  ...
  CreateReferenceType(
      address_space, data_items::id::DataGroupType, data_items::id::HasDevice,
      data_items::id::ChannelsPropertyCategory, "HasDevice",
      base::WideToUTF16(L"Устройство"), devices::id::DeviceType);
}
