...
TEST(NodeId, FromString) {
  ...
  EXPECT_EQ(NodeId(15, NamespaceIndexes::IEC60870_DEVICE), NodeId::FromString("IEC_DEV.15"));
  EXPECT_EQ(NodeId(12, NamespaceIndexes::IEC60870_DEVICE), NodeId::FromString("T11.12"));
...
TEST(NodeId, ToString) {
  ...
  EXPECT_EQ(NodeId(15, NamespaceIndexes::IEC60870_DEVICE).ToString(), "IEC_DEV.15");
