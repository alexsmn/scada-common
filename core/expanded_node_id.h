...
class ExpandedNodeId {
 public:
  ...
  bool operator!=(const ExpandedNodeId& other) const { return !operator==(other); }
...
inline ExpandedNodeId::ExpandedNodeId(NodeId node_id, String namespace_uri, unsigned server_index)
